  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white font-sans">
      ...
      <section className="py-20 px-6 text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-copper">Automatize seu negócio.<br />Humanize seu tempo.</h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          <a href="#contato" className="bg-copper text-white px-6 py-3 rounded-2xl shadow-md hover:opacity-90 transition">Falar com um Especialista</a>
          <a href="#" className="border border-copper text-copper px-6 py-3 rounded-2xl hover:bg-copper hover:text-white transition">Solicitar Demonstração</a>
        </div>
      </section>
      ...
      <section className="py-20 px-6 text-center" id="contato">
        <h2 className="text-3xl font-bold text-copper mb-4">Vamos conversar?</h2>
        <p className="text-neutral-300 mb-6">Clique abaixo para falar com o Lucas via WhatsApp.</p>
        <a href="https://wa.me/5511971021702" target="_blank" className="inline-block bg-copper text-white px-8 py-4 rounded-2xl text-lg font-semibold shadow hover:opacity-90 transition">
          Falar no WhatsApp
        </a>
      </section>
    </div>
